...
public class CheckerBoard {
    ...
    public void show(){
        System.out.print(Console.ANSI_GREEN+"    0  1  2  3  4  5  6  7" +Console.ANSI_RESET);
        for (int i = 0; i< HEIGHT; i++){
    ...
    void move(Coordinate origin, Coordinate target){
        ...
        this.movePiece(origin,Color.NULL_COLOR);
        this.movePiece(target,originColor);
    }
    ...
    void jump(Coordinate origin, Coordinate target){
        ...
        Color originColor = this.getColorPiece(origin);
        this.movePiece(origin,Color.NULL_COLOR);
        this.movePiece(intermediate,Color.NULL_COLOR);
        this.movePiece(target,originColor);
    }
